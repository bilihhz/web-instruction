...
const supplementSentence = [
    "然后若无其事的离开现场", "选择棕色头发的人最佳",
    "并且全程不让任何人发现", "骨头部分可以不用处理", "全程保持面无表情不说话",
    "做完之后抬头数十分钟的星星", "优先选择棕色头发的陌生人",
...
const easterEggs = [
    ...
    "找到一只山羊并骑在上面两小时，优先选择棕色头发的山羊。",
    "打开你最喜欢的游戏并给今天第一个登录的游戏充值任意金额。",
    "把自己的内脏挂在家中的墙上，骨头部分可以不用处理。",
    "假装自己是明星并让路人找你签名，直到对方报警为止。",
    "假装自己是警察并对路人说你被逮捕了，然后若无其事的离开现场。",
    "点一份外卖若超时就并且只给外卖员一块钱配送费。",
    "请前往附近的医院并跟医生坚持说自己有病并说出症状。",
    "在装满热牛奶的泳池中跳一支舞并把泳池里的牛奶喝完。",
    "打开边狱巴士并只用一次通关15牢。",
    "前往B站为你刷到的第一个视频，听mili的歌并三连。",
    "在漆黑的下水道念出苦痛是我的唯一，全程保持面无表情。",
    "找到一个时长11分45秒的视频并看完，做这件事时无需有任何犹豫。",
    "向暗恋的人表白并向右跳一下，完成后要向我汇报结果。",
    "亲吻你见到的第一个女生，直到她明确同意或者拒绝为止。"
];
